...
@include('staff.views.monitorings.modal', ['researchId' => $research->id])
@include('staff.views.externalfunds.modal', ['researchId' => $research->id])
@include('staff.views.researchteam.modal', ['researchId' => $research->id])

@include('staff.views.researchteam.edit', ['researchID' => $research->id])
@include('staff.views.monitorings.edit', ['researchID' => $research->id])
@include('staff.views.externalfunds.edit', ['researchId' => $research->id])
