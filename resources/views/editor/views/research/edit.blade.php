    ...
    <form action="{{ route('research.update', $research->id) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col mb-3">
                ...
                <select class="form-control" id="isInternalFund" name="isInternalFund">
                    <option value="">Internal Fund</option>
                    <option value="1" {{ $research->isInternalFund ? 'selected' : '' }}>True</option>
                    <option value="0" {{ !$research->isInternalFund ? 'selected' : '' }}>False</option>
                </select>
            </div>
        </div>
        <div class="col">
