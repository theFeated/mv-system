...
@section('contents')
    ...
    <form action="{{ route('research.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col">
                <label for="isInternalFund" class="form-label">Internal Fund<span class="text-danger"></span></label>
                <select class="custom-select" id="isInternalFund" name="isInternalFund">
