...
@section('contents')
    ...
    <form action="{{ route('researcher.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            <div class="col">
                <label for="id" class="form-label">User ID Number<span class="text-danger">*</span></label>
                <input type="number" name="id" class="form-control" placeholder="User ID" required>
            </div>
            <div class="col">
