<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark border accordion position-fixed mt-6 pre-scrollable hoverable" id="accordionSidebar" style="z-index: 100;">
  ...
  <!-- Nav Item - Dashboard -->
  <li class="nav-item d-flex justify-content-center {{ Request::routeIs('admin.dashboard')? 'active' : '' }}">
  ...
  <li class="nav-item d-flex justify-content-center {{ Request::routeIs('users') ? 'active' : '' }}">
