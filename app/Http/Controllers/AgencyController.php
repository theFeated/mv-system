...
class AgencyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('editor.views.agency.index', compact('agency'));
    }
    ...
    {
        return view('editor.views.agency.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('editor.views.agency.show', compact('agency'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('editor.views.agency.edit', compact('agency'));
    }
    ...
    public function restore()
    {
        ...
        return view('editor.views.agency.restore', ['archived' => $archivedAgency]);
    }
